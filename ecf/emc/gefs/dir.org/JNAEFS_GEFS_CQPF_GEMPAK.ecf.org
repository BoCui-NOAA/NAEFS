#PBS -N naefs_gefs_cqpf_gempak
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A NAEFS-DEV
#PBS -l walltime=01:30:00
#PBS -l select=1:ncpus=7:mpiprocs=7:mem=4GB
#PBS -l debug=true
...
export PDY=20220910
export cyc=00
export job=naefs_gefs_cqpf_gempak_$PDY$cyc
...
export APRUN="mpiexec -np 7 --cpu-bind core cfp "
export IOBUF_PARAMS='*:sync,%%stdout:sync'

#export cyc=%CYC%

${HOMEnaefs}/jobs/JNAEFS_GEFS_CQPF_GEMPAK
