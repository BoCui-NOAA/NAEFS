...
mkdir -p /gpfs/hps3/ptmp/emc.enspara1/bc/o/com/output
mkdir -p /gpfs/hps3/ptmp/emc.enspara1/bc/o/com/output/dev

COM_IN=/gpfs/hps3/emc/ensemble/noscrub/emc.enspara1/bc/o/com/naefs/dev
