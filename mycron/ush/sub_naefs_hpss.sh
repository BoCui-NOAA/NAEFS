...
$hpsstar put $file pgrb2ap5_bc > $output/output_hpss_pgrb2ap5_bc 2>&1&

#file=$HPSSOUT/rh${YER}/${MON}/${PDY}/com_naefs_dev_gefs.${PDY}_${cyc}.pgrb2ap5_an.tar
#$hpsstar put $file pgrb2ap5_an > $output/output_hpss_pgrb2ap5_an 2>&1&

file=$HPSSOUT/rh${YER}/${MON}/${PDY}/com_naefs_dev_gefs.${PDY}_${cyc}.ndgd_gb2.tar
$hpsstar put $file ndgd_gb2     > $output/output_hpss_ndgd_gb2 2>&1&         

file=$HPSSOUT/rh${YER}/${MON}/${PDY}/avgspr_gefs.${PDY}_${cyc}.pgrb2ap5_bc.tar
$hpsstar put $file pgrb2ap5_bc/*avg* pgrb2ap5_bc/*spr* > $output/output_hpss_gefs_pgrb2ap5_bc_avgspr 2>&1&

file=$HPSSOUT/rh${YER}/${MON}/${PDY}/avgspr_gefs.${PDY}_${cyc}.ndgd_gb2.tar
$hpsstar put $file ndgd_gb2/*avg* ndgd_gb2/*spr* > $output/output_hpss_gefs_ndgd_gb2_avgspr 2>&1&    
