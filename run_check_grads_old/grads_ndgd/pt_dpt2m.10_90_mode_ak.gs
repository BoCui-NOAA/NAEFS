...
'd dpt2m'
'run cbarn.gs'
'draw title Ensemble Average & Spread for DPT2m'
...
'd dpt2m.2'
'run cbarn.gs'
'draw title 10% Probability Forecast for DPT2m'
...
'd dpt2m.3'
'run cbarn.gs'
'draw title 90% Probability Forecast for DPT2m'
...
'd dpt2m.4'
'run cbarn.gs'
'draw title 50% Probability Forecast for DPT2m'

'set string 4'
'set strsiz 0.12'
*'draw string 8.6 0.15 BO CUI, GCWMB/EMC/NCEP/NOAA'
'print'
'disable print dpt2m.gr'
'c'
quit
