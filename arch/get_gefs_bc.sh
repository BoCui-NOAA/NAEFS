...
while [ $iday -le $ndays ]; do
  ...
  mkdir -p ${COMOUT}/gefs.${PDY}/${cyc}/pgrb2ap5_bc
 
  cd ${COMOUT}/gefs.${PDY}/${cyc}

# file=$HPSSOUT/rh${YER}/${MON}/${PDY}/com2_gens_prod_gefs.${PDY}_${cyc}.ensstat.tar 
  file=$HPSSOUT/rh${YER}/${MON}/${PDY}/gpfs_hps_nco_ops_com_naefs_prod_gefs.${PDY}_${cyc}.pgrb2ap5_bc.tar

# hpsstar inx $file 
# hpsstar get $file 

  for ifh in $hourlist; do
    hpsstar get $file ./pgrb2ap5_bc/geavg.t${cyc}z.pgrb2a.0p50_bcf$ifh
  done
