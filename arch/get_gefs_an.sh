...
while [ $iday -le $ndays ]; do
  ...
  file=$HPSSOUT/rh${YER}/${MON}/${PDY}/gpfs_hps_nco_ops_com_naefs_prod_gefs.${PDY}_${cyc}.pgrb2ap5_an.tar

# hpsstar inx $file 
# hpsstar get $file 

  for ifh in $hourlist; do
    hpsstar get $file ./pgrb2ap5_an/geavg.t${cyc}z.pgrb2a.0p50_anf$ifh
    hpsstar get $file ./pgrb2ap5_an/geavg.t${cyc}z.pgrb2a.0p50_anvf$ifh
  done
