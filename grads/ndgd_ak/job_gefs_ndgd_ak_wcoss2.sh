...
mkdir -p $DATA/tmpdir_gefs_ak 
cd $DATA/tmpdir_gefs_ak    
rm *.png
cp ../*gs .
  ...
  for nfhrs in $hourlist; do
    for mem in $memberlist; do 
      ...
      sed -e "s/PDY/$PDY/" \
       ...
       mv t2m_me.png      gefs_ak_t2m_${PDY}${cyc}.f${nfhrs}.png
       mv u10m_me.png     gefs_ak_u10m_${PDY}${cyc}.f${nfhrs}.png
       mv v10m_me.png     gefs_ak_v0m_${PDY}${cyc}.f${nfhrs}.png
       mv dpt2m_me.png    gefs_ak_dpt2m_${PDY}${cyc}.f${nfhrs}.png
       mv rh2m_me.png     gefs_ak_rh2m_${PDY}${cyc}.f${nfhrs}.png
       mv tmax2m_me.png   gefs_ak_tmax2m_${PDY}${cyc}.f${nfhrs}.png
       mv tmin2m_me.png   gefs_ak_tmin2m_${PDY}${cyc}.f${nfhrs}.png
       mv wind10m_me.png  gefs_ak_wind10m_${PDY}${cyc}.f${nfhrs}.png
