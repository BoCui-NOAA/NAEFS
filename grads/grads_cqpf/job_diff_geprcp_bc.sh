...
#while [ $iday -le $ndays ]; do
  ...
  for mem in $memberlist; do 
      ...
      $WGRIB2 -match "ens mean" ${infile}_$version  -append -grib  mean_${infile}_$version
      ...
      sed -e "s/PDY/$PDY/" \
       ...
       mv enscqpf.png  diff_geprcp_bc.${INTER}.${PDY}${cyc}.f${nfhrs}.png
    done
  done
  done
