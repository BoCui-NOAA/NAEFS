...
#while [ $iday -le $ndays ]; do
  ...
  for mem in $memberlist; do 
      ...
      version=v6.1
      rm $version.ctl
      infile=ge${mem}.t${cyc}z.pgrb2a.0p50.efif${nfhrs}
      ...
      sed -e "s/PDY/$PDY/" \
        ...
        -e "s/MMDD/$MMDD/" \
        -e "s/var/$var/" \
        diff_geprcp_efi.gs  >grads.gs

       grads -bcl "grads.gs"

       mv enscqpf.png  diff_geprcp_efi.${PDY}${cyc}.f${nfhrs}.png
    done
  done
