...
export tmpdir=$DATAROOT/cpqpf_tmp_${naefs_ver}
...
cat    $scripts/naefs.${naefs_ver}_CPQPF_6h_H.HTML   > CPQPF_6h.html
...
do
 ...
 sed -e "s/YYYYMMDDHH/$SYMDH/"  \
     -e "s/YYYYMMDD/$SYMD/"     \
     $scripts/naefs.${naefs_ver}_CPQPF_6h_M.HTML   >>CPQPF_6h.html
done

cat $scripts/CPQPF_6h_E.HTML   >>CPQPF_6h.html

cp CPQPF_6h.html naefs.${naefs_ver}_CPQPF_6h.html

#RZDMDIR=/home/people/emc/www/htdocs/gmb/wx20cb/GEFS_VRFY
RZDMDIR=${dir_main}/GEFS_VRFY 
$SHOME/xbin/ftpemcrzdm emcrzdm put $RZDMDIR $tmpdir naefs.${naefs_ver}_CPQPF_6h.html
