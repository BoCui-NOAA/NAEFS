...
#while [ $iday -le $ndays ]; do
  ...
  for nfhrs in $hourlist; do
    for mem in $memberlist; do 
      ...
      infile=fnmoc_glbanl.t${cyc}z.pgrb2a.0p50_mdf${nfhrs}      
      cp $COM1/fens.$PDYm2/$cyc/pgrb2ap5/$infile .
      ...
      infile=ncepfnmoc_glbanl.t${cyc}z.pgrb2a.0p50_mdf${nfhrs}      
      cp $COM1/gefs.$PDYm1/$cyc/pgrb2ap5/$infile .
      $g2ctl -verf $infile  > me.ctl
      /u/$LOGNAME/xbin/gribmap -i me.ctl
