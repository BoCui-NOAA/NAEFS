...
#COM1=/lfs/h2/emc/vpppg/noscrub/Bo.Cui/com/naefs/v6.1                      
...
export hourlist=" 240 360 "
export hourlist=" 042 054 "
...
while [ $iday -le $ndays ]; do
  ...
  for nfhrs in $hourlist; do
    for mem in $memberlist; do 
      ...
      infile=naefs.t${cyc}z.ge${mem}.f${nfhrs}.conus_ext_2p5.grib2
#     infile=gefs.t${cyc}z.ge${mem}.f${nfhrs}.alaska_3p0.grib2         
#     cp $COM1/naefs.$PDY/$cyc/ndgd_gb2/$infile .
      ...
      sed -e "s/PDY/$PDY/" \
       ...
       mv t2m_me.png      naefs_conus_t2m_${PDY}${cyc}.f${nfhrs}.png
       mv u10m_me.png     naefs_conus_u10m_${PDY}${cyc}.f${nfhrs}.png
       mv v10m_me.png     naefs_conus_v0m_${PDY}${cyc}.f${nfhrs}.png
       mv dpt2m_me.png    naefs_conus_dpt2m_${PDY}${cyc}.f${nfhrs}.png
       mv rh2m_me.png     naefs_conus_rh2m_${PDY}${cyc}.f${nfhrs}.png
       mv tmax2m_me.png   naefs_conus_tmax2m_${PDY}${cyc}.f${nfhrs}.png
       mv tmin2m_me.png   naefs_conus_tmin2m_${PDY}${cyc}.f${nfhrs}.png
       mv wind10m_me.png   naefs_conus_wind10m_${PDY}${cyc}.f${nfhrs}.png
