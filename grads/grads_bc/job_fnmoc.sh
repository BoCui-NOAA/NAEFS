...
while [ $iday -le $ndays ]; do
  ...
  for nfhrs in $hourlist; do
    for mem in $memberlist; do 
      ...
      infile=ncepfnmoc_glbanl.t00z.pgrb2a_mdf00               
      cp $COM1/gefs.$PDY/$cyc/pgrb2a/$infile .
      ...
      sed -e "s/PDY/$PDY/" \
        ...
        -e "s/mem/$mem/" \
        -e "s/MMDD/$MMDD/" \
        ncepfnmoc_glbanl_diff.gs  >grads.gs
       grads -bcl "grads.gs"

       mv t2m_me.png      ncepfnmoc_glbanl_diff_t2m_${PDY}${cyc}.f${nfhrs}.png
       mv z500_me.png     ncepfnmoc_glbanl_diff_z500_${PDY}${cyc}.f${nfhrs}.png
       mv z250_me.png     ncepfnmoc_glbanl_diff_z250_${PDY}${cyc}.f${nfhrs}.png
       mv t850_me.png     ncepfnmoc_glbanl_diff_t850_${PDY}${cyc}.f${nfhrs}.png
       mv u10m_me.png     ncepfnmoc_glbanl_diff_u10m_${PDY}${cyc}.f${nfhrs}.png
       mv v10m_me.png     ncepfnmoc_glbanl_diff_v10m_${PDY}${cyc}.f${nfhrs}.png
