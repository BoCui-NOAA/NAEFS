...
COM1=/gpfs/hps3/ptmp/Bo.Cui/com/gens/dev                                 
...
while [ $iday -le $ndays ]; do
  ...
  for nfhrs in $hourlist; do
    for mem in $memberlist; do 
      ...
      infile=ge${mem}.t${cyc}z.pgrb2a.0p50.f${nfhrs}
      ...
      sed -e "s/PDY/$PDY/" \
        ...
        -e "s/mem/$mem/" \
        -e "s/MMDD/$MMDD/" \
        gefs_raw.gs  >grads.gs
       grads -bcl "grads.gs"

       mv t2m_me.png      gefs_raw_t2m_${PDY}${cyc}.f${nfhrs}.png
       mv z500_me.png     gefs_raw_z500_${PDY}${cyc}.f${nfhrs}.png
       mv z250_me.png     gefs_raw_z250_${PDY}${cyc}.f${nfhrs}.png
       mv t850_me.png     gefs_raw_t850_${PDY}${cyc}.f${nfhrs}.png
       mv u10m_me.png     gefs_raw_u10m_${PDY}${cyc}.f${nfhrs}.png
       mv v10m_me.png     gefs_raw_v10m_${PDY}${cyc}.f${nfhrs}.png
