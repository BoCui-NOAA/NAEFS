...
DATA=/lfs/h2/emc/vpppg/noscrub/Bo.Cui/grads_naefs/grads_bc               
mkdir -p $DATA/tmpdir
cd $DATA/tmpdir
rm *
cp ../*gs .
...
while [ $iday -le $ndays ]; do
  ...
  for nfhrs in $hourlist; do
    for mem in $memberlist; do 
      ...
      infile=naefs_ge${mem}.t${cyc}z.pgrb2a.0p50_bcf${nfhrs}
      cp $COM1/naefs.$PDY/$cyc/pgrb2ap5_bc/$infile .
      ...
      sed -e "s/PDY/$PDY/" \
       ...
       mv t2m_me.png      naefs_bc_t2m_${PDY}${cyc}.f${nfhrs}.png
       mv z500_me.png     naefs_bc_z500_${PDY}${cyc}.f${nfhrs}.png
       mv z250_me.png     naefs_bc_z250_${PDY}${cyc}.f${nfhrs}.png
       mv t850_me.png     naefs_bc_t850_${PDY}${cyc}.f${nfhrs}.png
       mv u10m_me.png     naefs_bc_u10m_${PDY}${cyc}.f${nfhrs}.png
       mv v10m_me.png     naefs_bc_v10m_${PDY}${cyc}.f${nfhrs}.png
