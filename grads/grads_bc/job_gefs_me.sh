...
while [ $iday -le $ndays ]; do
  ...
  for nfhrs in $hourlist; do
    for mem in $memberlist; do 
      ...
      infile=ge${mem}.t${cyc}z.pgrb2a.0p50_mef${nfhrs}
      ...
      sed -e "s/PDY/$PDY/" \
       ...
       mv t2m_me.png      gefs_me_t2m_${PDY}${cyc}.f${nfhrs}.png
       mv z500_me.png     gefs_me_z500_${PDY}${cyc}.f${nfhrs}.png
       mv z250_me.png     gefs_me_z250_${PDY}${cyc}.f${nfhrs}.png
       mv t850_me.png     gefs_me_t850_${PDY}${cyc}.f${nfhrs}.png
       mv u10m_me.png     gefs_me_u10m_${PDY}${cyc}.f${nfhrs}.png
       mv v10m_me.png     gefs_me_v10m_${PDY}${cyc}.f${nfhrs}.png
