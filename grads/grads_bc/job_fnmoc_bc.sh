...
#while [ $iday -le $ndays ]; do
  ...
  for nfhrs in $hourlist; do
    for mem in $memberlist; do 
      ...
      infile=fnmoc_ge${mem}.t${cyc}z.pgrb2a.0p50_bcf${nfhrs}
      cp $COM1/fens.$PDY/$cyc/pgrb2a_bc/$infile .
      $g2ctl -verf $infile  > avg.ctl
      /u/$LOGNAME/xbin/gribmap -i avg.ctl

      infile=fnmoc_gespr.t${cyc}z.pgrb2a.0p50_bcf${nfhrs}
      cp $COM1/fens.$PDY/$cyc/pgrb2a_bc/$infile .
      $g2ctl -verf $infile  > spr.ctl
      /u/$LOGNAME/xbin/gribmap -i spr.ctl
      ...
      sed -e "s/PDY/$PDY/" \
        ...
        -e "s/mem/$mem/" \
        -e "s/MMDD/$MMDD/" \
        fnmoc_bc.gs  >grads.gs
       grads -bcl "grads.gs"

       mv t2m_me.png      fnmoc_bc_t2m_${PDY}${cyc}.f${nfhrs}.png
       mv z500_me.png     fnmoc_bc_z500_${PDY}${cyc}.f${nfhrs}.png
       mv z250_me.png     fnmoc_bc_z250_${PDY}${cyc}.f${nfhrs}.png
       mv t850_me.png     fnmoc_bc_t850_${PDY}${cyc}.f${nfhrs}.png
       mv u10m_me.png     fnmoc_bc_u10m_${PDY}${cyc}.f${nfhrs}.png
       mv v10m_me.png     fnmoc_bc_v10m_${PDY}${cyc}.f${nfhrs}.png
