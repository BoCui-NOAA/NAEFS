...
#DATA=/ptmp/Bo.Cui/infro_conus/cmce_ameavg_${stymd}_$edymd
mkdir -p $DATA
...
#   file=cmc_ge${nens}.t${cyc}z.ndgd_conus_amef${nfhrs}
    file=ge${nens}.t${cyc}z.ndgd_conus_amef${nfhrs}
    SFILE=$MEINPUT/cmce.$PDY/${cyc}/mevf_cmce/$file
...
# cp mean.output.$nfhrs $COMOUT/${file}_$1.$2
  cp mean.output.$nfhrs $COMOUT/cmc_${file}_$1.$2
