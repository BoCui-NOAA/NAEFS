...
*
grfile=''greg'_field_crpsf_CYC.png'
say grfile
*'gxprint 'grfile
'reset'
...
'gxprint 'grfile
*'gxprint 'greg'_field_crpsc_CYC.png x1100 y850'
'c'
...
*
grfile=''greg'_field_crpsc_CYC.png'
say grfile
*'gxprint 'grfile
'reset'
'set vpage 0.0 11.0 0.0 8.0'
...
*
'clear'
grfile=''greg'_field_rmsa_CYC.png'
say grfile
'reset'
...
*
'clear'
grfile=''greg'_field_rmsm_CYC.png'
say grfile
'reset'
...
*
'clear'
grfile=''greg'_field_merr_CYC.png'
say grfile
'reset'
...
*
'clear'
grfile=''greg'_field_ctp_CYC.png'
say grfile
'reset'
'set vpage 0 11 0 8.0'
'set grads off'
