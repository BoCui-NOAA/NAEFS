...
if(field=wspd10m);maxcrp=3.0;endif;
...
if(field=wspd10m);maxerr=5.0;endif;
...
if(field=tcdc);maxerr=45.0;endif
return maxerr
...
if(field=wspd10m);minbot=-1;endif;
...
if(field=tcdc);minbot=-1.0;endif
return minbot
