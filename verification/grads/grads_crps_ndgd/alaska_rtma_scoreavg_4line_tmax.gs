...
*
grfile='rtma_field_crpsf_CYC.png'
say grfile
'reset'
...
*
grfile='rtma_field_crpsc_CYC.png'
say grfile
'reset'
'set vpage 0.0 11.0 0.0 8.0'
'set grads off'
...
*
'clear'
grfile='rtma_field_rmsa_CYC.png'
say grfile
'reset'
...
*
'clear'
grfile='rtma_field_rmsm_CYC.png'
say grfile
'reset'
...
*
'clear'
grfile='rtma_field_merr_CYC.png'
say grfile
'reset'
...
if(reg=6);titreg='NAEFS Alaska';endif;
return titreg
...
if(field=u10m);maxcrp=4.0;endif;
if(field=v10m);maxcrp=4.0;endif;
if(field=t2m);maxcrp=2.6;endif;
if(field=dpt);maxcrp=3.0;endif;
if(field=wdir);maxcrp=60;endif;
if(field=wspd);maxcrp=3.0;endif;
if(field=tmax);maxcrp=2.5;endif;
if(field=tmin);maxcrp=2.5;endif;
...
if(field=u10m);maxrms=6.0;endif;
if(field=v10m);maxrms=6.0;endif;
if(field=t2m);maxrms=5.0;endif;
if(field=dpt);maxrms=6.0;endif;
if(field=wdir);maxrms=90;endif;
if(field=wspd);maxrms=6;endif;
if(field=tmax);maxrms=6;endif;
if(field=tmin);maxrms=6;endif;
if(field=rh2m);maxrms=18;endif;
return maxrms

function geterr(field)
if(field=pres);maxerr=2000;endif;
if(field=u10m);maxerr=6.0;endif;
if(field=v10m);maxerr=6.0;endif;
if(field=t2m);maxerr=4;endif;
if(field=dpt);maxerr=5;endif;
if(field=wdir);maxerr=80;endif;
if(field=wspd);maxerr=4.0;endif;
if(field=tmax);maxerr=4.5;endif;
if(field=tmin);maxerr=4.5;endif;
...
if(field=tmin);minbot=-1.5;endif;
return minbot
