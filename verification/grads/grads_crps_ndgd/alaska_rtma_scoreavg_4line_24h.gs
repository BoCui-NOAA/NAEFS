...
if(field=t2m);maxcrp=2.2;endif;
if(field=dpt);maxcrp=3.0;endif;
if(field=wdir);maxcrp=60;endif;
if(field=wspd);maxcrp=2.0;endif;
...
if(field=t2m);maxrms=4.5;endif;
if(field=dpt);maxrms=6.0;endif;
if(field=wdir);maxrms=90;endif;
if(field=wspd);maxrms=6;endif;
if(field=tmax);maxrms=4.5;endif;
if(field=tmin);maxrms=4.5;endif;
