...
export HOME=/gpfs/hps/emc/ensemble/save/Bo.Cui/naefs.v6.0.1
...
export DATAVRFY=/gpfs/hps/emc/ensemble/noscrub/Bo.Cui/naefs.v6.0.0/com/gens

export CENTER=crps_ndgd2p5_alaska             

#$SCOREMEAN $stymd $edymd gefs_raw2p5         alaska    
#$SCOREMEAN $stymd $edymd gefs_bc2p5          alaska    
#$SCOREMEAN $stymd $edymd gefs_p5raw2p5       alaska    

$SCOREMEAN $stymd $edymd gefs_bcds          alaska    
$SCOREMEAN $stymd $edymd naefs_bcds          alaska    
$SCOREMEAN $stymd $edymd gefs_p5bcds          alaska    
$SCOREMEAN $stymd $edymd naefs_p5bcds          alaska    
...
ls -l $HOME/grads_crps_rtma/explot_rtma_scoreavg.sh
...
dir_new=crps_4lines_dev_$stymd.${etymd}_ak
