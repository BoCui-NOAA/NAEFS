...
'set ccolor 1'
'set cmark 1'
'd skip(1-ctp90.1,4,1)'

'set cstyle 5'
'set ccolor 2'
'set cmark 2'
'd skip(1-ctp90.2,4,1)'

'set cstyle 5'
'set ccolor 3'
'set cmark 3'
'd skip(1-ctp90.3,4,1)'

'set cstyle 5'
'set ccolor 4'
'set cmark 4'
'd skip(1-ctp90.4,4,1)'
...
if(field=dpt);maxcrp=2.2;endif;
if(field=wdir);maxcrp=65;endif;
if(field=wspd);maxcrp=2.5;endif;
if(field=tmax);maxcrp=2.6;endif;
if(field=tmin);maxcrp=2.6;endif;
...
if(field=u10m);maxerr=4.0;endif;
if(field=v10m);maxerr=4.0;endif;
if(field=t2m);maxerr=5;endif;
if(field=dpt);maxerr=5;endif;
if(field=wdir);maxerr=120;endif;
if(field=wspd);maxerr=4;endif;
if(field=tmax);maxerr=4;endif;
if(field=tmin);maxerr=4;endif;
