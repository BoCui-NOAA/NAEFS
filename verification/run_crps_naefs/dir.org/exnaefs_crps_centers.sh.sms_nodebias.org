...
#export COMCLIM=/com/rtma/prod 
#export COMOUT=/ptmp/wx20cb/infro_vrfy/naefs.${PDY}/${cyc}/score_drbcds
#export DATA=$PTMP/$LOGNAME/infro_vrfy/scores_gefs_drbcds_$PDY$cyc
...
###
# Center 1: forecast files entry, ensembel average, ensemble spread
###
...
###
# Center 2: forecast files entry, ensembel average, ensemble spread
###
