...
export COMIN=/gpfs/hps/emc/ensemble/save/Bo.Cui/naefs.v6.0.1
export HOMESH=/gpfs/hps/emc/ensemble/save/Bo.Cui/naefs.v6.0.1      
...
job=$COMIN/run_crps_naefs/exnaefs_crps.sh.sms_1d
...
# export runini=NO 
  ...
  export COMCLIM=$HOMESH/fix_1d

  if [ "$IFECMWF" = "YES" ]; then
    export COMOUT=$NGLOBAL/$LOGNAME/com/gens/crps_ecmwf/wrt_ecmwf_gfs 
  elif [ "$IFNCEP" = "YES" ]; then
    export COMOUT=/gpfs/hps/emc/ensemble/noscrub/Bo.Cui/naefs.v6.0.0/com/gens/crps_gefs
  fi
