...
#export EXECVERF=$HOMESH/NUOPC_2012/exec
#export EXECVERF=/ensemble/save/Bo.Cui/ECMWF/exec
#export EXECVERF=/ensemble/save/Bo.Cui/naefs.v5.0.0/exec
export EXECVERF=/gpfs/hps/emc/ensemble/save/Bo.Cui/naefs.v6.0.1/exec
...
fieldlist=" 2MTMP 10MUGRD 10MVGRD 1000HGT 500HGT 850TMP DPT2M "

fieldlist=" 10MWIND"        
#export hourlist="003 006"
...
#     COMANL=$NGLOBAL/Bo.Cui/com/gens/prod/gefs.${aymd}/${acyc}/pgrbap5
      COMANL=/gpfs/hps/emc/ensemble/noscrub/emc.enspara1/bc/o/com/naefs/dev/gefs.${aymd}/${acyc}/pgrbap5
...
# fi
  ...
  case $cfield in
    ...
    TCDC) COMANL=$COMA/gefs.${aymd_m06}/${acyc_m06}/pgrba;;
  esac

  COMFCST=$COM/${id}.${fymd}/${fcyc}/pgrbap5$ex
  if [ "$ENSIM" = "gefs_rawp5" ]; then
    COMFCST=$COM/${id}.${fymd}/${fcyc}/pgrbap5
  fi

  case $cfield in
#   TMAX) afile1=gec00.t${acyc_m06}z.pgrbaf06;;
#   TMIN) afile1=gec00.t${acyc_m06}z.pgrbaf06;;
#   TCDC) afile1=gec00.t${acyc_m06}z.pgrbaf00;;
    TCDC) afile1=gegfs.t${acyc_m06}z.pgrbaf06;;
    TMAX) afile1=gegfs.t${acyc_m06}z.pgrbaf06;;
    TMIN) afile1=gegfs.t${acyc_m06}z.pgrbaf06;;
  esac
...
# cfile1=$COMFCST/${px}geavg.t${fcyc}z.pgrbap5.0p50${ex}f${nfhrs}
  cfile1=$COMFCST/${px}geavg.t${fcyc}z.pgrba.0p50${ex}f${nfhrs}_wind
...
# cfile2=$COMFCST/${px}gespr.t${fcyc}z.pgrbap5.0p50${ex}f${nfhrs}
  COMFCSTT=/gpfs/hps/emc/ensemble/noscrub/Bo.Cui/naefs.v6.0.0/com/gens/prod/${id}.${fymd}/${fcyc}/pgrbap5_bc
  cfile2=$COMFCSTT/${px}gespr.t${fcyc}z.pgrbap5.0p50_bcf${nfhrs}
