...
if (la1.eq.21.and.la2.eq.140.and.lo1.eq.1.and.lo2.eq.720) reg='NH'
if (la1.eq.220.and.la2.eq.340.and.lo1.eq.1.and.lo2.eq.720) reg='SH'
if (la1.eq.140.and.la2.eq.220.and.lo1.eq.1.and.lo2.eq.720) reg='TR'
if (la1.eq.60.and.la2.eq.140.and.lo1.eq.440.and.lo2.eq.630) reg='NA'
if (la1.eq.22.and.la2.eq.120.and.lo1.eq.1.and.lo2.eq.90) reg='EU'
if (la1.eq.22.and.la2.eq.160.and.lo1.eq.90.and.lo2.eq.280) reg='AS'
