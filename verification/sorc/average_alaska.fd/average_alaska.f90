...
integer     maxgrd,ndata,ilen,lpgb                                
...
!   call phasechange(tbias,maxgrd,2)
!   print *, '----- Wind Direction Average after Adjustment in [0,360) ------'
!   call moreinfro(tbias,maxgrd,kpdsout,kensout,lbms,ivar)
! endif
...
! call grange(maxgrd,lbmsout,tbias,dmin,dmax)
! print*, 'Irec pds5 pds6 pds7 pds8 pds9 pd10 pd11 pd14 e2  e3  ndata   Maximun    Minimum    data'
! print '(i4,8i5,2i4,i8,3f10.2)',ivar,(kpdsout(i),i=5,11),kpdsout(14),(kensout(i),i=2,3),maxgrd,dmax,dmin,tbias(30000)  
! print *,'        '
